...
async function categorize() {
    ...
    // if no matching diagnoses at all, set isPsychiatricDx, isNeurocognitiveDx, isOtherDx, isEndOfLife to false
    if (!isPsychiatricDx && !isNeurocognitiveDx && !isOtherDx && !isEndOfLife) {
        isPsychiatricDx = false;
        isNeurocognitiveDx = false;
        isOtherDx = false;
        isEndOfLife = false;
    }
    ...
    // ask user to input if non-pharmacological approaches have been tried, side effect present, and if MHT is involved
